...
";
        if ($groupId) {
            ...
            curl_setopt_array($curl, [
                ...
                CURLOPT_HTTPHEADER     => [
                    ...
                    // Use the group-specific authentication key
                    'Authorization: ' . AUTH_KEY_GROUP
                ],
                CURLOPT_TIMEOUT        => 10,
            ]);
            $resp = curl_exec($curl);
        ...
        if (function_exists('isPaketProrata') && isPaketProrata($idPaket)) {
            ...
            if (function_exists('waNotifProrata')) {
                ...
                // Ensure waNotifProrata uses AUTH_KEY_CUSTOMER internally or accepts it as a parameter
...
";
            ...
            curl_setopt_array($curl2, [
                ...
                CURLOPT_HTTPHEADER     => [
                    'Content-Type: application/json',
                    // Use the customer-specific authentication key
                    'Authorization: ' . AUTH_KEY_CUSTOMER
                ],
                CURLOPT_TIMEOUT        => 10,
            ]);
